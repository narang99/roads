...
- now i need a get a bit better at synth generation.  
- Its better to scale fragments
- I shouldnt put too many of them
- I should put them on ground
- Its best to first create a function which works for a single image


- Get the placement mask using segformer and specific classes
- get natural backdrops
- place garbage (with perspective true) at correct places
  - we need to atleast make sure the direction is generally correct (left / right)
  - later i can add perspective lines